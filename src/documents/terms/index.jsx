    ...
    return (
        <Box>
            ...
            <DocSections title="Intro">
                ...
                <p style={pt}>Welcome to Website Name!</p>
                <p style={pt}>These terms and conditions outline the rules and regulations for the use of Company Name's Website, located at Website.com.</p>
                <p style={pt}>
            ...
            <DocSections title="License">
                ...
                <ul>
                    <li>Republish material from Website Name
                    </li>
                    <li>Sell, rent or sub-license material from Website Name
                    </li>
                    <li>Reproduce, duplicate or copy material from Website Name
                    </li>
            ...
            <DocSections title="Hyperlinking to our Content">
                The followingorganizations may link to our Website without prior written approval:
                <ul>
